...
func (r *MovieRepository) GetTopMovies() ([]models.Movie, error) {
	return r.getMovies("ORDER BY popularity DESC")
}

func (r *MovieRepository) GetRandomMovies() ([]models.Movie, error) {
	return r.getMovies("ORDER BY random() DESC")
}

func (r *MovieRepository) getMovies(queryDetails string, params ...any) ([]models.Movie, error) {
	query := `
	...
	params = append([]any{defaultLimit}, params...)

	rows, err := r.db.Query(fmt.Sprintf(query, queryDetails), params...)
	if err != nil {
